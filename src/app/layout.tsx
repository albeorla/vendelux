...
export const metadata: Metadata = {
  title: "EventFlow | Discover Your Next Experience",
  description: "Find events that match your vibe. Answer a few questions and we'll curate the perfect experiences for you.",
};
